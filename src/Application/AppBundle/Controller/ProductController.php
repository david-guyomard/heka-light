...
use Application\AppBundle\Entity\Product;
...
class ProductController extends Controller
{
    ...
    {
        $product = new Product();
        $form = $this->createForm('Application\AppBundle\Form\ProductType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('Application\AppBundle\Form\ProductType', $product);
